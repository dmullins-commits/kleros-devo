...
export default function StationsWorkoutPlayer({ config, workoutName, onClose, totalWorkoutTime: overallWorkoutTime, elapsedBeforeCurrentSection = 0, onElapsedTimeUpdate, totalRemainingTime, autoStartInMultiTimer = false }) {
